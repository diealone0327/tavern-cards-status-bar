...
const passiveSkills = new Set([
  '精液疗伤', '精液灌体',
  '玉液功', '催情香体', '灵舌术',
  '琴心', '棋魂', '书道', '画骨', '厨神之手', '品茶宗师', '品酒宗师', '花艺', '舞艺', '房中术', '医术精通',
]);

const skillDesc: Record<string, string> = {
  // 修为技能
  '精液疗伤': '射在对方伤口上可快速愈合，对内伤也有效',
  '精液灌体': '射入对方体内时，可提升对方修为进度+5~10，对方每日限一次',
  '精液破障': '射入对方体内时，可跳过对方当前一个小境界，仅限小境界突破',
  // NSFW技能
  '玉液功': '精液附带催情效果，对方摄入后情欲大幅提升',
  '共感链接': '可指定两人建立感官链接，双方共享触觉和快感，持续时间内无法自行断开',
  '魅惑之瞳': '对视时发动，让对方陷入短暂恍惚，服从一个简单指令',
