...
const itemDesc: Record<string, string> = {
  ...
  '破界丹': '直接突破当前大境界（无视天劫）',
  // 法宝
  '金梭镖': '金属性法器·极品。锋锐破甲，三枚金梭可遥控飞袭击穿护甲',
  '青藤索': '木属性法器·极品。缠绕困敌并汲取灵力，亦可编织藤盾格挡',
  '分水珠': '水属性法器·极品。减速冻结，凝水为幕可减速困敌，化冰为刃可冻结攻敌',
  '烈火旗': '火属性法器·极品。灼烧焚敌，烈焰升腾可攻敌焚阵，火墙环绕可护自身',
  '玄土罩': '土属性法器·极品。沉重镇压，凝土为盾可挡攻击，化土为刺可攻敌手',
  '万象令': '通用型法器·极品。可记录一道法术攻防皆可，每日限用一次',
  '金刚圈': '金属性灵器·极品。锋锐破甲，金环高速旋转可切割击穿护甲',
  '青木鼎': '木属性灵器·极品。攻防一体，鼎身可挡强攻，鼎中青木之气可化藤鞭攻敌',
  '玄冰鉴': '水属性灵器·极品。减速冻结，镜面凝冰可冻结目标，亦可化冰盾护体',
  '紫火钟': '火属性灵器·极品。灼烧焚敌，钟身可护自身，紫火可焚敌困敌',
  '厚土幡': '土属性灵器·极品。沉重镇压，幡动召土墙困敌镇压，亦化土刺石锥攻敌',
  '混元伞': '通用型灵器·极品。撑开可挡攻击，收拢可作兵器挥砸',
  '金罡环': '金属性仙器·极品。锋锐破甲，金罡之气可撕裂元婴级护甲',
  '青帝灵藤': '木属性仙器·极品。缠绕汲取，万藤齐发可囚敌攻敌并汲取修为',
  '玄冥珠': '水属性仙器·极品。减速冻结，玄冥水幕可大幅减速目标，冰锥可冻结强敌',
  '离天鼎': '火属性仙器·极品。灼烧焚敌，鼎身可挡攻击，离火可炼化攻敌',
  '镇天印': '土属性仙器·极品。沉重镇压，印身如山可镇杀强敌，亦化土壁护持自身',
  '周天盘': '通用型仙器·极品。盘转星辰之力可攻敌困敌，盘面可挡法术攻击',
  '金蛟剪': '金属性神器·极品。锋锐破甲，双刃交错可剪断同阶护甲法宝',
  '青木灵杖': '木属性神器·极品。缠绕禁锢，万千藤蔓缠绕禁锢强敌，亦可织盾护体',
  '玄水珠': '水属性神器·极品。减速冻结，水幕可大幅减速冻结目标，冰龙席卷冻结一方',
  '离火旗': '火属性神器·极品。灼烧焚敌，火墙护体，火海攻八方',
  '厚土印': '土属性神器·极品。沉重镇压，印如山岳可镇杀强敌，土壁环绕可护自身',
  '天机镜': '通用型神器·极品。镜光可破虚妄攻敌神识，镜面可挡法术攻击',
  '镇魂钟': '神识类神器·极品。钟鸣震魂，扰乱神识打断施法，可定弱者的神魂',
  '锁神甲': '神识类神器·极品。护持神识海，抵御高阶神识冲击和搜魂术',
  '万象珠': '神识类神器·极品。大幅增强神识感知范围，可大范围神识搜索',
  // 武器
